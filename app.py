...
chat_interface = gr.ChatInterface(yes_man, chatbot=gr.Chatbot(height=300),
                                  ...
                                  theme="soft", examples=[
        "Menda ko'zlarning sarg'ayishi, mushak og'rig'i, terining sarg'ayishi va qorin og'rig'i kuzatilyapti"],
                                  retry_btn=None, undo_btn="O'chirish", clear_btn="Tozalash", )
...
pneumo_interface = gr.Interface(fn=image_processing_function, inputs=text_input, outputs="text", title="Pnevmaniya",
                                description="""!!! Bu shunchaki suniy intelekt tomonidan berilgan maslahat. Ko'proq ma'lumot olish uchun tajribali doktorlar bilan bog'laning !!! 
    Iltimos faqat o'pkaga oid bo'lgan sifatli rasm kiriting!""", theme="soft", examples=["data/norm.jpg"], live=False)
...
final = gr.TabbedInterface([chat_interface, pneumo_interface, consult_interface],
                           tab_names=['Chatbot', 'Rasm Tashxisi', 'Konsultatsiya'])
